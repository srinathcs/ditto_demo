...
class MainActivity : AppCompatActivity(), NewTaskDialogFragment.NewTaskDialogListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.content.recyclerView.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))

        // Create an instance of Ditto
        val androidDependencies = DefaultAndroidDittoDependencies(applicationContext)
        val ditto = Ditto(androidDependencies, DittoIdentity.OnlinePlayground(androidDependencies, "e82dc9d4-bff8-4d3c-9bb5-d966832a1de4", "5f65ed7c-fa74-451d-802d-26e5a71eb911"))
        this.ditto = ditto
        ...
        val swipeHandler = object : SwipeToDeleteCallback(this) {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                val adapter = binding.content.recyclerView.adapter as TasksAdapter
